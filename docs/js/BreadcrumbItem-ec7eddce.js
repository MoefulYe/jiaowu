import{f as P,z as m,B as s,C as T,A as u,d as g,m as y,K as C,p as H,F as j,v as p,L as S,q as v,k as $,r as E,x as I,eh as _,ay as A,i as O,ar as w}from"./index-3ae6663b.js";const N={fontWeightActive:"400"},V=e=>{const{fontSize:o,textColor3:r,textColor2:a,borderRadius:n,buttonColor2Hover:t,buttonColor2Pressed:c}=e;return Object.assign(Object.assign({},N),{fontSize:o,itemLineHeight:"1.25",itemTextColor:r,itemTextColorHover:a,itemTextColorPressed:a,itemTextColorActive:a,itemBorderRadius:n,itemColorHover:t,itemColorPressed:c,separatorColor:r})},K={name:"Breadcrumb",common:P,self:V},F=K,M=m("breadcrumb",`
 white-space: nowrap;
 cursor: default;
